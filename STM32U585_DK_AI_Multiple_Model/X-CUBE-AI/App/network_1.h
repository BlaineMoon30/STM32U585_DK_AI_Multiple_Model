...
#define AI_NETWORK_1_ORIGIN_MODEL_NAME   "cnn_mnist"
...
#define AI_NETWORK_1_IN_1_HEIGHT      (28)
#define AI_NETWORK_1_IN_1_WIDTH       (28)
#define AI_NETWORK_1_IN_1_CHANNEL     (1)
#define AI_NETWORK_1_IN_1_SIZE        (28 * 28 * 1)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (3136)
