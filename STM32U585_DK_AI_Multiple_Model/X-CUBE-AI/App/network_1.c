...
#define AI_NETWORK_1_MODEL_SIGNATURE     "81afd4b6bd26eee19a0570308eb5b6c5"
...
#define AI_TOOLS_DATE_TIME   "Fri Aug  4 11:28:00 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1_OUT_NUM, &dense_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_1_activations_map, 1, params)) {
    ...
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_network_1_activations_map[0] + 3136);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_network_1_activations_map[0] + 3136);
    
    conv2d_conv2d_output_array.data = AI_PTR(g_network_1_activations_map[0] + 9792);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 9792);
    
    conv2d_1_conv2d_scratch0_array.data = AI_PTR(g_network_1_activations_map[0] + 0);
    conv2d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_1_activations_map[0] + 0);
    
    conv2d_1_conv2d_output_array.data = AI_PTR(g_network_1_activations_map[0] + 8512);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 8512);
    ...
    dense_output_array.data = AI_PTR(g_network_1_activations_map[0] + 40);
    dense_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 40);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_1_weights_map, 1, params)) {
    ...
    conv2d_conv2d_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 1152);
    conv2d_conv2d_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 1152);
    
    conv2d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 1280);
    conv2d_1_conv2d_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 1280);
    
    conv2d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 75008);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 75008);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 75264);
    dense_dense_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 75264);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 139264);
    dense_dense_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 139264);
