...
#define AI_NETWORK_MODEL_SIGNATURE     "74d5685a0a92da916657e72339a4d668"
...
#define AI_TOOLS_DATE_TIME   "Fri Aug  4 11:27:51 2023"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_3_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    dense_3_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    
    dense_3_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    dense_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    ...
    dense_4_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    dense_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    
    dense_5_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_5_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    dense_5_output_array.data = AI_PTR(g_network_activations_map[0] + 12);
    dense_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_5_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 32);
    dense_5_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 32);
    
    dense_5_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_5_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 128);
    dense_5_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 140);
    dense_3_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 140);
    
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 300);
    dense_3_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 300);
    
    dense_4_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_4_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 340);
    dense_4_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 340);
